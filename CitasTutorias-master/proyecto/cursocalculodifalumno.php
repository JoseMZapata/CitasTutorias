...
<body>
    ...
    <main class="ContenidoPrincipalCursoAlumno">
        <div class="ContenidoPrincipalCursoAlumno--Tareas barraslaterales" >
            <div>
                <picture>
                    ...
                    <img loading="lazy" src="img/Curso2CalculoDiferencial.jpg" alt="">
                </picture>
            </div>
            <div>
                <div>
        ...
        <div class="ContenidoPrincipalCursoAlumno--ActividadesVencer barraslaterales">
            ...
            <div>
                <ul>
                    <li><a href="calendarioprofesor.php">Investigacion de donde se pueden aplicar las derivadas</a></li>
                    <li><a href="#">Actividad: Realizar 10 derivadas</a></li>
                </ul>
