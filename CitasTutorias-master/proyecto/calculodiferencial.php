    ...
    <main class="ContenidoPrincipalArte">
        <div class="ContenidoPrincipalArte1">
            ...
            <div class="ContenidoPrincipalArte1--hijos">
                ...
                <div>
                    <p>El cálculo diferencial es la rama del cálculo, asociada al cálculo infinitesimal y el análisis matemático, que permite el estudio de las funciones continuas a partir del uso las derivadas.</p>
                </div>
                <div>
